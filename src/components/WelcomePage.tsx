        ...
        <div className="">
            <div className="h-screen flex justify-center items-center flex-col space-y-8 bg-gradient-to-br from-slate-50 to-gray-500">
                ...
                <button
                    ...
                    className="flex items-center justify-between px-6 py-3 bg-gradient-to-br from-slate-50 to-gray-500/30 ring-1 ring-black/5 rounded-lg text-lg hover:bg-hovergray hover:ring-2 hover:ring-hovergray transition duration-300 animate-bounce hover:animate-none group"
                >
