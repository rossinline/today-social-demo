...
const NavBar = () => {
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div className="w-20 h-20 hover:cursor-pointer bg-white/30 rounded-widget ring-1 ring-black/5 mb-4 items-center justify-center hidden lg:flex" title="Today">
      ...
      <div className="z-20 w-full h-20 bg-white/90 rounded-t-widget ring-1 ring-black/5 p-4 lg:mb-4 fixed bottom-0 left-0 lg:relative lg:w-20 lg:h-auto lg:flex-col lg:items-center lg:space-y-4 lg:p-4 lg:bg-white/30 lg:rounded-widget">
        <ul className="flex justify-center items-center w-full lg:flex-col lg:space-x-0">
          <li>
            {/* Logo Container for Mobile */}
            <div className="w-12 h-12 hover:cursor-pointer bg-white/30 rounded-[15px] ring-1 ring-black/5 items-center justify-center flex lg:hidden mx-2">
